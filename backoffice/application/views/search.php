...
<html lang="en">
  <head>
   ...
   <link rel="stylesheet" type="text/css" href="<?php echo base_url('testt/css/main.css') ?>">
    ...
    <script src="<?php echo base_url('lib/lib/jquery-1.7.2.min.js') ?>" type="text/javascript"></script>
  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            ...
            <li ><a href="<?php echo base_url('index.php/Member_code_admin') ?>">Acceuil</a></li>
            <li ><a href="<?php echo base_url('index.php/Search') ?>">Refresh</a></li>
            <li ><a href="<?php echo base_url('index.php/Listes_admin') ?>">Listes d'utilisateurs</a></li>
