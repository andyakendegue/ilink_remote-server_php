...
<html lang="en">
  ...
  <!--<![endif]-->
        ...
        <div class="navbar-inner">
                ...
                <a class="brand" href="Listes_users"><span class="second">ILINK-</span> <span class="first">App.com</span></a>
        </div>
    </div>
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            ...
            <li ><a href="Member_code">Acceuil</a></li>
            <li ><a href="Listes_users">Refresh</a></li>
            <li>
...
?>
    ...
    <div class='modal-footer'>
        <button class='btn' data-dismiss='modal' aria-hidden='true'>Annuler</button>
        <a <a href='Listes_users/delete/?recordId=$row->phone' role='button' class='btn btn-danger'>
        Effacer</a>
    </div>
</div>
